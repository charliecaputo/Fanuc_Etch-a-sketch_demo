...
- servo_control: Current working version of "Encoder_Teleop". requires "encoder_read" to be running in order to work
...
- encoder_read: reads the encoders and publishes the data. should be ran with the following: ros2 run test_py encoder_read --ros-args --params-file ~/fanuc_ws/src/test_py/config/demo_params.yaml
