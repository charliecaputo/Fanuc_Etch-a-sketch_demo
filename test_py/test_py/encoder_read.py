...
class EncoderTestPublisher(Node):

    def __init__(self):

        super().__init__(
            "encoder_test_publisher"
        )
        ...
        self.y_pub = self.create_publisher(
            Float32,
            "encoder_y_mm",
            10
        )
        ...
        self.amplitude = 1.0      # mm per update
        ...
        self.get_logger().info(
            "Encoder test publisher started"
        )
